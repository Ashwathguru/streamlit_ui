...
st.markdown(f'<html>
            ...
            <img src="{charcater_path}" style="border-radius: 50%;width:90% ;border:5px solid black;">
            <br><br>   
            <button class="open-button" id="myBtn"  style= " background-color: #010000;color: white; padding: 16px 20px;border: none;border-radius: 8px;cursor: pointer;width: 200px;">Ask about it</button> 
            </div> 
            <div id="myModal" class="modal"> <div class="modal-content"> <div> 
            <span class="close">&times;</span> <video width="1000" height="700" style="margin-top:-50px;margin-left:100px"  autoplay loop  muted> 
            <source src="{video}" type="video/mp4">  
            <source src="movie.ogg" type="video/ogg">  
            <div style="margin-left:45%;  margin-top:-3%;">  
            <button type="reset"  class=".button-chat" style="background-color:transparent; border-color:transparent;">  
            <img src="{micImg}" height="55"/></button> <button type="reset"  class="button-mic" style="background-color:transparent; border-color:transparent;">  
